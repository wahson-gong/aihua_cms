...
class IncController extends BaseController{
	...
	public function showDuotiaojiluAction(){
	    $guanlianziduan=$_GET["guanlianziduan"];
	    $guanlianziduan_val=$_GET["guanlianziduan_val"];
	...
	public function fileuploadAction(){
	    ...
	    $targetDir = 'public/webuploader/upload_tmp';
	    $uploadDir = 'public/webuploader/upload';
